  ...
  "suggestedSGP": "Best 4-6 leg combo with correlation reasoning"
    ...
    const aiRes = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        system:"You are a sharp NBA betting analyst JSON API. You have access to web search — use it FIRST to search for today's injury report for both teams before generating props. Always return valid JSON with sgpLegs. Never refuse. No markdown, no backticks.",
